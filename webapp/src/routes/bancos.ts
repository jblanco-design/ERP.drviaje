    ...
    return c.html(`
      <div style="font-family:sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;background:#f3f4f6;">
        <div style="background:white;border-radius:12px;padding:40px;max-width:400px;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.1);">
          ...
          <p style="color:#6b7280;margin-bottom:24px;">El rol <strong>Observador</strong> solo tiene permisos de visualización. No puede abrir, cerrar ni modificar cajas ni cuentas bancarias.</p>
          <a href="/bancos" style="background:#7B3FA0;color:white;padding:10px 24px;border-radius:8px;text-decoration:none;font-weight:600;">← Volver</a>
        </div>
      </div>
    `, 403)
  }
